    ...
    : TaskWidget(parent, taskName)
{
    const QString description =
            ...
            "Whether a review belongs in the class is determined by whether sentiment analyzer VADER"
            "result has significant deviation from the users rating.\n\n"
            ...
            "known if WordNet is able to find any synsets for the word. A word without synsets is considered unknown.\n\n"
